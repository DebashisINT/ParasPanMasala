package com.breezefsmparas.features.permissionList
...
import com.breezefsmparas.test.viewPermission.AdapterViewPermission
        ...
        for(i in 0..list.size-1){
            if(list1.get(i)!="android.permission.ACCESS_GPS") {
                var obj: PermissionDetails = PermissionDetails(list1.get(i).replace("android.permission.", "").replace("_", " ")
                        ...
                        replace("com.breezefsmparas.permission.C2D",""), list.get(i))
