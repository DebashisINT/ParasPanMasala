package com.breezefsmparas.features.logoutsync.presentation
...
import com.breezefsmparas.CustomConstants


import com.breezefsmparas.R
import com.breezefsmparas.app.AppDatabase
...
import com.breezefsmparas.app.utils.Toaster
import com.breezefsmparas.base.BaseResponse
import com.breezefsmparas.base.presentation.BaseActivity
import com.breezefsmparas.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezefsmparas.features.billing.api.AddBillingRepoProvider
import com.breezefsmparas.features.billing.model.AddBillingInputParamsModel
...
import com.breezefsmparas.features.dashboard.presentation.ReasonDialog
...
import com.breezefsmparas.features.document.model.AddEditDocumentInputParams
import com.breezefsmparas.features.document.model.DocumentAttachmentModel
...
import com.breezefsmparas.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.breezefsmparas.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.breezefsmparas.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezefsmparas.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezefsmparas.features.orderhistory.model.*
...
import com.breezefsmparas.features.quotation.model.AddQuotInputModel
import com.breezefsmparas.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefsmparas.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
...
import com.breezefsmparas.features.stockAddCurrentStock.ShopAddCurrentStockList
import com.breezefsmparas.features.stockAddCurrentStock.ShopAddCurrentStockRequest
import com.breezefsmparas.features.stockAddCurrentStock.api.ShopAddStockProvider
import com.breezefsmparas.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.breezefsmparas.features.timesheet.model.AddTimeSheetInputModel
import com.breezefsmparas.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezefsmparas.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezefsmparas.features.viewAllOrder.model.AddOrderInputProductList
import com.breezefsmparas.mappackage.SendBrod
import com.breezefsmparas.widgets.AppCustomTextView
import com.breezefsmparas.MonitorService
import com.breezefsmparas.MySingleton
import com.breezefsmparas.features.addshop.model.*
import com.breezefsmparas.features.addshop.model.assigntopplist.AddShopUploadImg
import com.breezefsmparas.features.addshop.presentation.ShopExtraContactReq
import com.breezefsmparas.features.addshop.presentation.multiContactRequestData
...
import com.breezefsmparas.features.login.model.GetConcurrentUserResponse
import com.breezefsmparas.features.login.model.WhatsappApiData
import com.breezefsmparas.features.orderITC.SyncDeleteOppt
import com.breezefsmparas.features.orderITC.SyncDeleteOpptL
import com.breezefsmparas.features.orderITC.SyncEditOppt
import com.breezefsmparas.features.orderITC.SyncOppt
import com.breezefsmparas.features.orderITC.SyncOpptProductL
import com.breezefsmparas.features.orderITC.SyncOrd
import com.breezefsmparas.features.orderITC.SyncOrdProductL
import com.breezefsmparas.features.performance.model.Gps_status_list
import com.breezefsmparas.features.performance.model.UpdateGpsInputListParamsModel
import com.breezefsmparas.features.returnsOrder.ReturnProductList
import com.breezefsmparas.features.returnsOrder.ReturnRequest
import com.breezefsmparas.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmparaslogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmparaslogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmparaslogsample/log.zip").path);
