package com.breezefsmparas.features.dashboard.presentation
...
import com.breezefsmparas.*
import com.breezefsmparas.R
import com.breezefsmparas.app.*
import com.breezefsmparas.app.NewFileUtils.browseDocuments
import com.breezefsmparas.app.NewFileUtils.browsePDFDocuments
import com.breezefsmparas.app.NewFileUtils.getExtension
import com.breezefsmparas.app.domain.*
import com.breezefsmparas.app.types.DashboardType
import com.breezefsmparas.app.types.FragType
import com.breezefsmparas.app.types.TopBarConfig
import com.breezefsmparas.app.uiaction.DisplayAlert
import com.breezefsmparas.app.utils.*
import com.breezefsmparas.app.utils.AppUtils.Companion.isProfile
import com.breezefsmparas.base.BaseResponse
import com.breezefsmparas.base.presentation.BaseActivity
import com.breezefsmparas.base.presentation.BaseFragment
import com.breezefsmparas.features.NewQuotation.*
import com.breezefsmparas.features.NewQuotation.api.GetQuotRegProvider
import com.breezefsmparas.features.NewQuotation.model.ViewDetailsQuotResponse
import com.breezefsmparas.features.SearchLocation.SearchLocationFragment
import com.breezefsmparas.features.SearchLocation.locationInfoModel
import com.breezefsmparas.features.TA.ViewAllTAListFragment
import com.breezefsmparas.features.achievement.AchievementFragment
import com.breezefsmparas.features.activities.presentation.*
import com.breezefsmparas.features.addAttendence.*
import com.breezefsmparas.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.breezefsmparas.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.breezefsmparas.features.addAttendence.model.GetReportToFCMResponse
import com.breezefsmparas.features.addAttendence.model.GetReportToResponse
import com.breezefsmparas.features.addAttendence.model.Leave_list_Response
import com.breezefsmparas.features.addorder.presentation.AddOrderFragment
...
import com.breezefsmparas.features.addshop.presentation.AddShopFragment
import com.breezefsmparas.features.addshop.presentation.OTPVerificationDialog
import com.breezefsmparas.features.addshop.presentation.ScanImageFragment
import com.breezefsmparas.features.addshop.presentation.ShowCardDetailsDialog
import com.breezefsmparas.features.alarm.model.AlarmData
import com.breezefsmparas.features.alarm.presetation.AttendanceReportFragment
import com.breezefsmparas.features.alarm.presetation.PerformanceReportFragment
import com.breezefsmparas.features.alarm.presetation.VisitReportDetailsFragment
import com.breezefsmparas.features.alarm.presetation.VisitReportFragment
import com.breezefsmparas.features.attendance.AttendanceFragment
import com.breezefsmparas.features.attendance.api.AttendanceRepositoryProvider
import com.breezefsmparas.features.attendance.model.AttendanceRequest
import com.breezefsmparas.features.attendance.model.AttendanceResponse
import com.breezefsmparas.features.averageshop.presentation.AverageShopFragment
import com.breezefsmparas.features.avgorder.presentation.AverageOrderFragment
import com.breezefsmparas.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.breezefsmparas.features.beatCustom.TeamBeatListFragment
import com.breezefsmparas.features.billing.presentation.AddBillingFragment
import com.breezefsmparas.features.billing.presentation.BillingDetailsFragment
import com.breezefsmparas.features.billing.presentation.BillingListFragment
import com.breezefsmparas.features.changepassword.presentation.ChangePasswordDialog
import com.breezefsmparas.features.chat.model.ChatListDataModel
import com.breezefsmparas.features.chat.model.ChatUserDataModel
import com.breezefsmparas.features.chat.model.GroupUserDataModel
import com.breezefsmparas.features.chat.presentation.*
import com.breezefsmparas.features.chatbot.presentation.ChatBotFragment
import com.breezefsmparas.features.chatbot.presentation.ChatBotShopListFragment
import com.breezefsmparas.features.chatbot.presentation.ReportsFragment
import com.breezefsmparas.features.chatbot.presentation.SelectLanguageDialog
import com.breezefsmparas.features.commondialog.presentation.CommonDialog
import com.breezefsmparas.features.commondialog.presentation.CommonDialogClickListener
import com.breezefsmparas.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.breezefsmparas.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.breezefsmparas.features.commondialogsinglebtn.OnDialogClickListener
import com.breezefsmparas.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.breezefsmparas.features.contacts.ActivityDtlsFrag
import com.breezefsmparas.features.contacts.AddOpptFrag
import com.breezefsmparas.features.contacts.ContactDtls
import com.breezefsmparas.features.contacts.ContactGr
import com.breezefsmparas.features.contacts.ContactsAddFrag
import com.breezefsmparas.features.contacts.ContactsFrag
import com.breezefsmparas.features.contacts.SchedulerViewFrag
import com.breezefsmparas.features.contacts.SchedulerAddFormFrag
import com.breezefsmparas.features.contacts.TemplateAddFrag
import com.breezefsmparas.features.contacts.TemplateViewFrag
import com.breezefsmparas.features.contacts.ViewCrmOpptFrag
import com.breezefsmparas.features.dailyPlan.prsentation.AllShopListFragment
import com.breezefsmparas.features.dailyPlan.prsentation.DailyPlanListFragment
import com.breezefsmparas.features.dailyPlan.prsentation.PlanDetailsFragment
import com.breezefsmparas.features.damageProduct.ShopDamageProductListFrag
import com.breezefsmparas.features.damageProduct.ShopDamageProductSubmitFrag
import com.breezefsmparas.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.breezefsmparas.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.breezefsmparas.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.breezefsmparas.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.breezefsmparas.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.breezefsmparas.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.breezefsmparas.features.dashboard.presentation.model.ContentListResponseModel
import com.breezefsmparas.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.breezefsmparas.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.breezefsmparas.features.device_info.presentation.DeviceInfoListFragment
import com.breezefsmparas.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.breezefsmparas.features.document.DocumentRepoFeatureNewFragment
import com.breezefsmparas.features.document.presentation.DocumentListFragment
import com.breezefsmparas.features.document.presentation.DocumentTypeListFragment
import com.breezefsmparas.features.document.presentation.OpenFileWebViewFragment
import com.breezefsmparas.features.dymanicSection.presentation.AddDynamicFragment
import com.breezefsmparas.features.dymanicSection.presentation.AllDynamicListFragment
import com.breezefsmparas.features.dymanicSection.presentation.DynamicListFragment
import com.breezefsmparas.features.dymanicSection.presentation.EditDynamicFragment
import com.breezefsmparas.features.gpsDisabilityScreen.GpsDisableFragment
import com.breezefsmparas.features.home.presentation.HomeFragment
import com.breezefsmparas.features.homelocation.presentation.HomeLocationFragment
import com.breezefsmparas.features.homelocation.presentation.HomeLocationMapFragment
import com.breezefsmparas.features.know_your_state.KnowYourStateFragment
import com.breezefsmparas.features.lead.LeadFrag
import com.breezefsmparas.features.lead.ViewLeadFrag
import com.breezefsmparas.features.leaderboard.LeaderBoardFrag
import com.breezefsmparas.features.leaveapplynew.LeaveHome
import com.breezefsmparas.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.breezefsmparas.features.localshops.LocalShopListFragment
import com.breezefsmparas.features.localshops.LocalShopListMapFragment
import com.breezefsmparas.features.localshops.NearByShopsMapFragment
import com.breezefsmparas.features.location.*
import com.breezefsmparas.features.location.api.LocationRepoProvider
import com.breezefsmparas.features.location.model.*
import com.breezefsmparas.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.breezefsmparas.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.breezefsmparas.features.login.ShopFeedbackEntity
import com.breezefsmparas.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.breezefsmparas.features.login.presentation.LoginActivity
import com.breezefsmparas.features.logout.presentation.api.LogoutRepositoryProvider
import com.breezefsmparas.features.logoutsync.presentation.LogoutSyncFragment
import com.breezefsmparas.features.marketAssist.MarketAssistTabFrag
import com.breezefsmparas.features.marketAssist.ShopDtlsMarketAssistFrag
import com.breezefsmparas.features.marketAssist.ShopListMarketAssistFrag
import com.breezefsmparas.features.marketing.presentation.MarketingPagerFragment
import com.breezefsmparas.features.meetinglist.prsentation.MeetingListFragment
import com.breezefsmparas.features.member.MapViewForTeamFrag
import com.breezefsmparas.features.member.model.TeamLocDataModel
import com.breezefsmparas.features.member.model.TeamShopListDataModel
import com.breezefsmparas.features.member.presentation.*
import com.breezefsmparas.features.menuBeat.MenuBeatFrag
import com.breezefsmparas.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.breezefsmparas.features.micro_learning.presentation.MicroLearningListFragment
import com.breezefsmparas.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.breezefsmparas.features.myallowancerequest.MyallowanceRequestFragment
import com.breezefsmparas.features.myjobs.model.CustomerDataModel
import com.breezefsmparas.features.myjobs.presentation.*
import com.breezefsmparas.features.mylearning.MyLearningFragment
import com.breezefsmparas.features.myorder.presentation.MyOrderListFragment
import com.breezefsmparas.features.myprofile.presentation.MyProfileFragment
import com.breezefsmparas.features.nearbyshops.api.ShopListRepositoryProvider
import com.breezefsmparas.features.nearbyshops.model.ShopData
import com.breezefsmparas.features.nearbyshops.model.ShopListResponse
import com.breezefsmparas.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.breezefsmparas.features.nearbyshops.presentation.BeatListFragment
import com.breezefsmparas.features.nearbyshops.presentation.NearByShopsListFragment
import com.breezefsmparas.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.breezefsmparas.features.nearbyshops.presentation.ShopCallHisFrag
import com.breezefsmparas.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.breezefsmparas.features.newcollection.CollectionDetailsStatusFragment
import com.breezefsmparas.features.newcollection.CollectionShopListFragment
import com.breezefsmparas.features.newcollection.NewCollectionListFragment
import com.breezefsmparas.features.newcollectionreport.*
import com.breezefsmparas.features.notification.NotificationFragment
import com.breezefsmparas.features.orderITC.CartListFrag
import com.breezefsmparas.features.orderITC.OrderListFrag
import com.breezefsmparas.features.orderITC.ProductListFrag
import com.breezefsmparas.features.orderITC.ViewNewOrdHisAllFrag
import com.breezefsmparas.features.orderITC.ViewNewOrdHistoryFrag
import com.breezefsmparas.features.orderITC.ViewOrdDtls
import com.breezefsmparas.features.orderList.NewDateWiseOrderListFragment
import com.breezefsmparas.features.orderList.NewOrderListFragment
import com.breezefsmparas.features.orderList.OrderListFragment
import com.breezefsmparas.features.orderdetail.presentation.OrderDetailFragment
import com.breezefsmparas.features.orderhistory.ActivityMapFragment
import com.breezefsmparas.features.orderhistory.OrderhistoryFragment
import com.breezefsmparas.features.orderhistory.TimeLineFragment
import com.breezefsmparas.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
...
import com.breezefsmparas.features.orderhistory.model.LocationData
import com.breezefsmparas.features.pendinglocationinout.PendingOutLocationFrag
import com.breezefsmparas.features.performance.GpsStatusFragment
import com.breezefsmparas.features.performance.PerformanceFragment
import com.breezefsmparas.features.performance.api.UpdateGpsStatusRepoProvider
import com.breezefsmparas.features.performance.model.UpdateGpsInputParamsModel
import com.breezefsmparas.features.performanceAPP.OwnPerformanceFragment
import com.breezefsmparas.features.performanceAPP.PerformanceAppFragment
import com.breezefsmparas.features.performanceAPP.allPerformanceFrag
import com.breezefsmparas.features.permissionList.ViewPermissionFragment
import com.breezefsmparas.features.photoReg.*
import com.breezefsmparas.features.privacypolicy.PrivacypolicyWebviewFrag
import com.breezefsmparas.features.quotation.presentation.*
import com.breezefsmparas.features.reimbursement.presentation.*
import com.breezefsmparas.features.report.presentation.*
import com.breezefsmparas.features.returnsOrder.*
import com.breezefsmparas.features.settings.presentation.SettingsFragment
import com.breezefsmparas.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.breezefsmparas.features.shopdetail.presentation.*
import com.breezefsmparas.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefsmparas.features.stock.StockDetailsFragment
import com.breezefsmparas.features.stock.StockListFragment
import com.breezefsmparas.features.stockAddCurrentStock.AddShopStockFragment
import com.breezefsmparas.features.stockAddCurrentStock.UpdateShopStockFragment
import com.breezefsmparas.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.breezefsmparas.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.breezefsmparas.features.stockCompetetorStock.AddCompetetorStockFragment
import com.breezefsmparas.features.stockCompetetorStock.CompetetorStockFragment
import com.breezefsmparas.features.stockCompetetorStock.ViewComStockProductDetails
import com.breezefsmparas.features.survey.SurveyFrag
import com.breezefsmparas.features.survey.SurveyViewDtlsFrag
import com.breezefsmparas.features.survey.SurveyViewFrag
import com.breezefsmparas.features.task.presentation.AddTaskFragment
import com.breezefsmparas.features.task.presentation.CalenderTaskFragment
import com.breezefsmparas.features.task.presentation.EditTaskFragment
import com.breezefsmparas.features.task.presentation.TaskListFragment
import com.breezefsmparas.features.taskManagement.TaskManagementFrag
import com.breezefsmparas.features.taskManagement.ViewTaskManagementFrag
import com.breezefsmparas.features.timesheet.presentation.AddTimeSheetFragment
import com.breezefsmparas.features.timesheet.presentation.EditTimeSheetFragment
import com.breezefsmparas.features.timesheet.presentation.TimeSheetListFragment
import com.breezefsmparas.features.viewAllOrder.CartFragment
import com.breezefsmparas.features.viewAllOrder.OrderTypeListFragment
import com.breezefsmparas.features.viewAllOrder.ViewAllOrderListFragment
import com.breezefsmparas.features.viewAllOrder.ViewCartFragment
import com.breezefsmparas.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.breezefsmparas.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.breezefsmparas.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.breezefsmparas.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.breezefsmparas.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.breezefsmparas.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.breezefsmparas.features.viewPPDDStock.ViewOutstandingFragment
import com.breezefsmparas.features.viewPPDDStock.ViewPPDDListFragment
import com.breezefsmparas.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.breezefsmparas.features.viewPPDDStock.ViewStockFragment
import com.breezefsmparas.features.weather.presentation.WeatherFragment
import com.breezefsmparas.mappackage.MapActivity
import com.breezefsmparas.mappackage.MapActivityWithoutPath
import com.breezefsmparas.mappackage.SendBrod
import com.breezefsmparas.widgets.AppCustomEditText
import com.breezefsmparas.widgets.AppCustomTextView
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xbreezefsmparaslogsample/log").path);
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmparaslogsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.breezefsmparas/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmparaslogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmparaslogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmparaslogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmparaslogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
