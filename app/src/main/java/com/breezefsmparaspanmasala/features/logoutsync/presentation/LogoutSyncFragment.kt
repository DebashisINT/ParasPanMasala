package com.breezefsmparaspanmasala.features.logoutsync.presentation
...
import com.breezefsmparaspanmasala.app.utils.Toaster
import com.breezefsmparaspanmasala.base.BaseResponse
import com.breezefsmparaspanmasala.base.presentation.BaseActivity
import com.breezefsmparaspanmasala.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezefsmparaspanmasala.features.billing.api.AddBillingRepoProvider
import com.breezefsmparaspanmasala.features.billing.model.AddBillingInputParamsModel
...
import com.breezefsmparaspanmasala.features.dashboard.presentation.ReasonDialog
...
import com.breezefsmparaspanmasala.features.document.model.AddEditDocumentInputParams
import com.breezefsmparaspanmasala.features.document.model.DocumentAttachmentModel
...
import com.breezefsmparaspanmasala.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.breezefsmparaspanmasala.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.breezefsmparaspanmasala.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezefsmparaspanmasala.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezefsmparaspanmasala.features.orderhistory.model.*
...
import com.breezefsmparaspanmasala.features.quotation.model.AddQuotInputModel
import com.breezefsmparaspanmasala.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefsmparaspanmasala.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezefsmparaspanmasala.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezefsmparaspanmasala.features.stockAddCurrentStock.ShopAddCurrentStockList
import com.breezefsmparaspanmasala.features.stockAddCurrentStock.ShopAddCurrentStockRequest
...
import com.breezefsmparaspanmasala.features.timesheet.model.AddTimeSheetInputModel
import com.breezefsmparaspanmasala.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezefsmparaspanmasala.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezefsmparaspanmasala.features.viewAllOrder.model.AddOrderInputProductList
import com.breezefsmparaspanmasala.mappackage.SendBrod
import com.breezefsmparaspanmasala.widgets.AppCustomTextView
import com.breezefsmparaspanmasala.MonitorService
import com.breezefsmparaspanmasala.MySingleton
...
import com.breezefsmparaspanmasala.features.addshop.presentation.ShopExtraContactReq
...
import com.breezefsmparaspanmasala.features.login.model.GetConcurrentUserResponse
import com.breezefsmparaspanmasala.features.login.model.WhatsappApiData
import com.breezefsmparaspanmasala.features.performance.model.Gps_status_list
import com.breezefsmparaspanmasala.features.performance.model.UpdateGpsInputListParamsModel
import com.breezefsmparaspanmasala.features.returnsOrder.ReturnProductList
import com.breezefsmparaspanmasala.features.returnsOrder.ReturnRequest
import com.breezefsmparaspanmasala.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmparaspanmasalalogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmparaspanmasalalogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmparaspanmasalalogsample/log.zip").path);
