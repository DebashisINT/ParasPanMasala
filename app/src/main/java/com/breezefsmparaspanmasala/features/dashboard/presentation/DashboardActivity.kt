package com.breezefsmparaspanmasala.features.dashboard.presentation
...
import com.breezefsmparaspanmasala.*
import com.breezefsmparaspanmasala.R
import com.breezefsmparaspanmasala.app.*
import com.breezefsmparaspanmasala.app.NewFileUtils.browseDocuments
import com.breezefsmparaspanmasala.app.NewFileUtils.getExtension
import com.breezefsmparaspanmasala.app.domain.*
import com.breezefsmparaspanmasala.app.types.DashboardType
import com.breezefsmparaspanmasala.app.types.FragType
import com.breezefsmparaspanmasala.app.types.TopBarConfig
import com.breezefsmparaspanmasala.app.uiaction.DisplayAlert
import com.breezefsmparaspanmasala.app.utils.*
import com.breezefsmparaspanmasala.app.utils.AppUtils.Companion.isProfile
...
import com.breezefsmparaspanmasala.features.NewQuotation.*
import com.breezefsmparaspanmasala.features.NewQuotation.api.GetQuotRegProvider
import com.breezefsmparaspanmasala.features.NewQuotation.model.ViewDetailsQuotResponse
import com.breezefsmparaspanmasala.features.SearchLocation.SearchLocationFragment
import com.breezefsmparaspanmasala.features.SearchLocation.locationInfoModel
import com.breezefsmparaspanmasala.features.TA.ViewAllTAListFragment
import com.breezefsmparaspanmasala.features.achievement.AchievementFragment
import com.breezefsmparaspanmasala.features.activities.presentation.*
import com.breezefsmparaspanmasala.features.addAttendence.*
import com.breezefsmparaspanmasala.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.breezefsmparaspanmasala.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.breezefsmparaspanmasala.features.addAttendence.model.GetReportToFCMResponse
import com.breezefsmparaspanmasala.features.addAttendence.model.GetReportToResponse
import com.breezefsmparaspanmasala.features.addAttendence.model.Leave_list_Response
import com.breezefsmparaspanmasala.features.addorder.presentation.AddOrderFragment
import com.breezefsmparaspanmasala.features.addshop.model.AddShopRequestData
import com.breezefsmparaspanmasala.features.addshop.model.AddShopResponse
import com.breezefsmparaspanmasala.features.addshop.presentation.AddShopFragment
import com.breezefsmparaspanmasala.features.addshop.presentation.OTPVerificationDialog
import com.breezefsmparaspanmasala.features.addshop.presentation.ScanImageFragment
import com.breezefsmparaspanmasala.features.addshop.presentation.ShowCardDetailsDialog
import com.breezefsmparaspanmasala.features.alarm.model.AlarmData
import com.breezefsmparaspanmasala.features.alarm.presetation.AttendanceReportFragment
import com.breezefsmparaspanmasala.features.alarm.presetation.PerformanceReportFragment
import com.breezefsmparaspanmasala.features.alarm.presetation.VisitReportDetailsFragment
import com.breezefsmparaspanmasala.features.alarm.presetation.VisitReportFragment
import com.breezefsmparaspanmasala.features.attendance.AttendanceFragment
import com.breezefsmparaspanmasala.features.attendance.api.AttendanceRepositoryProvider
import com.breezefsmparaspanmasala.features.attendance.model.AttendanceRequest
import com.breezefsmparaspanmasala.features.attendance.model.AttendanceResponse
import com.breezefsmparaspanmasala.features.averageshop.presentation.AverageShopFragment
import com.breezefsmparaspanmasala.features.avgorder.presentation.AverageOrderFragment
import com.breezefsmparaspanmasala.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.breezefsmparaspanmasala.features.beatCustom.TeamBeatListFragment
import com.breezefsmparaspanmasala.features.billing.presentation.AddBillingFragment
import com.breezefsmparaspanmasala.features.billing.presentation.BillingDetailsFragment
import com.breezefsmparaspanmasala.features.billing.presentation.BillingListFragment
import com.breezefsmparaspanmasala.features.changepassword.presentation.ChangePasswordDialog
import com.breezefsmparaspanmasala.features.chat.model.ChatListDataModel
import com.breezefsmparaspanmasala.features.chat.model.ChatUserDataModel
import com.breezefsmparaspanmasala.features.chat.model.GroupUserDataModel
import com.breezefsmparaspanmasala.features.chat.presentation.*
import com.breezefsmparaspanmasala.features.chatbot.presentation.ChatBotFragment
import com.breezefsmparaspanmasala.features.chatbot.presentation.ChatBotShopListFragment
import com.breezefsmparaspanmasala.features.chatbot.presentation.ReportsFragment
import com.breezefsmparaspanmasala.features.chatbot.presentation.SelectLanguageDialog
import com.breezefsmparaspanmasala.features.commondialog.presentation.CommonDialog
import com.breezefsmparaspanmasala.features.commondialog.presentation.CommonDialogClickListener
import com.breezefsmparaspanmasala.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.breezefsmparaspanmasala.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.breezefsmparaspanmasala.features.commondialogsinglebtn.OnDialogClickListener
import com.breezefsmparaspanmasala.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.breezefsmparaspanmasala.features.dailyPlan.prsentation.AllShopListFragment
import com.breezefsmparaspanmasala.features.dailyPlan.prsentation.DailyPlanListFragment
import com.breezefsmparaspanmasala.features.dailyPlan.prsentation.PlanDetailsFragment
import com.breezefsmparaspanmasala.features.damageProduct.ShopDamageProductListFrag
import com.breezefsmparaspanmasala.features.damageProduct.ShopDamageProductSubmitFrag
import com.breezefsmparaspanmasala.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.breezefsmparaspanmasala.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.breezefsmparaspanmasala.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.breezefsmparaspanmasala.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.breezefsmparaspanmasala.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.breezefsmparaspanmasala.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.breezefsmparaspanmasala.features.dashboard.presentation.model.ContentListResponseModel
import com.breezefsmparaspanmasala.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.breezefsmparaspanmasala.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.breezefsmparaspanmasala.features.device_info.presentation.DeviceInfoListFragment
import com.breezefsmparaspanmasala.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.breezefsmparaspanmasala.features.document.DocumentRepoFeatureNewFragment
import com.breezefsmparaspanmasala.features.document.presentation.DocumentListFragment
import com.breezefsmparaspanmasala.features.document.presentation.DocumentTypeListFragment
import com.breezefsmparaspanmasala.features.document.presentation.OpenFileWebViewFragment
import com.breezefsmparaspanmasala.features.dymanicSection.presentation.AddDynamicFragment
import com.breezefsmparaspanmasala.features.dymanicSection.presentation.AllDynamicListFragment
import com.breezefsmparaspanmasala.features.dymanicSection.presentation.DynamicListFragment
import com.breezefsmparaspanmasala.features.dymanicSection.presentation.EditDynamicFragment
import com.breezefsmparaspanmasala.features.gpsDisabilityScreen.GpsDisableFragment
import com.breezefsmparaspanmasala.features.home.presentation.HomeFragment
import com.breezefsmparaspanmasala.features.homelocation.presentation.HomeLocationFragment
import com.breezefsmparaspanmasala.features.homelocation.presentation.HomeLocationMapFragment
import com.breezefsmparaspanmasala.features.know_your_state.KnowYourStateFragment
import com.breezefsmparaspanmasala.features.lead.LeadFrag
import com.breezefsmparaspanmasala.features.lead.ViewLeadFrag
import com.breezefsmparaspanmasala.features.leaveapplynew.LeaveHome
import com.breezefsmparaspanmasala.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.breezefsmparaspanmasala.features.localshops.LocalShopListFragment
import com.breezefsmparaspanmasala.features.localshops.LocalShopListMapFragment
import com.breezefsmparaspanmasala.features.localshops.NearByShopsMapFragment
import com.breezefsmparaspanmasala.features.location.*
import com.breezefsmparaspanmasala.features.location.api.LocationRepoProvider
import com.breezefsmparaspanmasala.features.location.model.*
import com.breezefsmparaspanmasala.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.breezefsmparaspanmasala.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.breezefsmparaspanmasala.features.login.ShopFeedbackEntity
import com.breezefsmparaspanmasala.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.breezefsmparaspanmasala.features.login.presentation.LoginActivity
import com.breezefsmparaspanmasala.features.logout.presentation.api.LogoutRepositoryProvider
import com.breezefsmparaspanmasala.features.logoutsync.presentation.LogoutSyncFragment
import com.breezefsmparaspanmasala.features.marketing.presentation.MarketingPagerFragment
import com.breezefsmparaspanmasala.features.meetinglist.prsentation.MeetingListFragment
import com.breezefsmparaspanmasala.features.member.MapViewForTeamFrag
import com.breezefsmparaspanmasala.features.member.model.TeamLocDataModel
import com.breezefsmparaspanmasala.features.member.model.TeamShopListDataModel
import com.breezefsmparaspanmasala.features.member.presentation.*
import com.breezefsmparaspanmasala.features.menuBeat.MenuBeatFrag
import com.breezefsmparaspanmasala.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.breezefsmparaspanmasala.features.micro_learning.presentation.MicroLearningListFragment
import com.breezefsmparaspanmasala.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.breezefsmparaspanmasala.features.myallowancerequest.MyallowanceRequestFragment
import com.breezefsmparaspanmasala.features.myjobs.model.CustomerDataModel
import com.breezefsmparaspanmasala.features.myjobs.presentation.*
import com.breezefsmparaspanmasala.features.myorder.presentation.MyOrderListFragment
import com.breezefsmparaspanmasala.features.myprofile.presentation.MyProfileFragment
import com.breezefsmparaspanmasala.features.nearbyshops.api.ShopListRepositoryProvider
import com.breezefsmparaspanmasala.features.nearbyshops.model.ShopData
import com.breezefsmparaspanmasala.features.nearbyshops.model.ShopListResponse
import com.breezefsmparaspanmasala.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.breezefsmparaspanmasala.features.nearbyshops.presentation.BeatListFragment
import com.breezefsmparaspanmasala.features.nearbyshops.presentation.NearByShopsListFragment
import com.breezefsmparaspanmasala.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.breezefsmparaspanmasala.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.breezefsmparaspanmasala.features.newcollection.CollectionDetailsStatusFragment
import com.breezefsmparaspanmasala.features.newcollection.CollectionShopListFragment
import com.breezefsmparaspanmasala.features.newcollection.NewCollectionListFragment
import com.breezefsmparaspanmasala.features.newcollectionreport.*
import com.breezefsmparaspanmasala.features.notification.NotificationFragment
import com.breezefsmparaspanmasala.features.orderList.NewDateWiseOrderListFragment
import com.breezefsmparaspanmasala.features.orderList.NewOrderListFragment
import com.breezefsmparaspanmasala.features.orderList.OrderListFragment
import com.breezefsmparaspanmasala.features.orderdetail.presentation.OrderDetailFragment
import com.breezefsmparaspanmasala.features.orderhistory.ActivityMapFragment
import com.breezefsmparaspanmasala.features.orderhistory.OrderhistoryFragment
import com.breezefsmparaspanmasala.features.orderhistory.TimeLineFragment
import com.breezefsmparaspanmasala.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezefsmparaspanmasala.features.orderhistory.model.FetchLocationRequest
import com.breezefsmparaspanmasala.features.orderhistory.model.FetchLocationResponse
import com.breezefsmparaspanmasala.features.orderhistory.model.LocationData
import com.breezefsmparaspanmasala.features.pendinglocationinout.PendingOutLocationFrag
import com.breezefsmparaspanmasala.features.performance.GpsStatusFragment
import com.breezefsmparaspanmasala.features.performance.PerformanceFragment
import com.breezefsmparaspanmasala.features.performance.api.UpdateGpsStatusRepoProvider
import com.breezefsmparaspanmasala.features.performance.model.UpdateGpsInputParamsModel
import com.breezefsmparaspanmasala.features.performanceAPP.PerformanceAppFragment
import com.breezefsmparaspanmasala.features.permissionList.ViewPermissionFragment
import com.breezefsmparaspanmasala.features.photoReg.*
import com.breezefsmparaspanmasala.features.privacypolicy.PrivacypolicyWebviewFrag
import com.breezefsmparaspanmasala.features.quotation.presentation.*
import com.breezefsmparaspanmasala.features.reimbursement.presentation.*
import com.breezefsmparaspanmasala.features.report.presentation.*
import com.breezefsmparaspanmasala.features.returnsOrder.*
import com.breezefsmparaspanmasala.features.settings.presentation.SettingsFragment
import com.breezefsmparaspanmasala.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.breezefsmparaspanmasala.features.shopdetail.presentation.*
import com.breezefsmparaspanmasala.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefsmparaspanmasala.features.stock.StockDetailsFragment
import com.breezefsmparaspanmasala.features.stock.StockListFragment
import com.breezefsmparaspanmasala.features.stockAddCurrentStock.AddShopStockFragment
import com.breezefsmparaspanmasala.features.stockAddCurrentStock.UpdateShopStockFragment
import com.breezefsmparaspanmasala.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.breezefsmparaspanmasala.features.stockCompetetorStock.AddCompetetorStockFragment
import com.breezefsmparaspanmasala.features.stockCompetetorStock.CompetetorStockFragment
import com.breezefsmparaspanmasala.features.stockCompetetorStock.ViewComStockProductDetails
import com.breezefsmparaspanmasala.features.survey.SurveyFrag
import com.breezefsmparaspanmasala.features.survey.SurveyViewDtlsFrag
import com.breezefsmparaspanmasala.features.survey.SurveyViewFrag
import com.breezefsmparaspanmasala.features.task.presentation.AddTaskFragment
import com.breezefsmparaspanmasala.features.task.presentation.CalenderTaskFragment
import com.breezefsmparaspanmasala.features.task.presentation.EditTaskFragment
import com.breezefsmparaspanmasala.features.task.presentation.TaskListFragment
import com.breezefsmparaspanmasala.features.taskManagement.TaskManagementFrag
import com.breezefsmparaspanmasala.features.taskManagement.ViewTaskManagementFrag
import com.breezefsmparaspanmasala.features.timesheet.presentation.AddTimeSheetFragment
import com.breezefsmparaspanmasala.features.timesheet.presentation.EditTimeSheetFragment
import com.breezefsmparaspanmasala.features.timesheet.presentation.TimeSheetListFragment
import com.breezefsmparaspanmasala.features.viewAllOrder.CartFragment
import com.breezefsmparaspanmasala.features.viewAllOrder.OrderTypeListFragment
import com.breezefsmparaspanmasala.features.viewAllOrder.ViewAllOrderListFragment
import com.breezefsmparaspanmasala.features.viewAllOrder.ViewCartFragment
import com.breezefsmparaspanmasala.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.breezefsmparaspanmasala.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.breezefsmparaspanmasala.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.breezefsmparaspanmasala.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.breezefsmparaspanmasala.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.breezefsmparaspanmasala.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.breezefsmparaspanmasala.features.viewPPDDStock.ViewOutstandingFragment
import com.breezefsmparaspanmasala.features.viewPPDDStock.ViewPPDDListFragment
import com.breezefsmparaspanmasala.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.breezefsmparaspanmasala.features.viewPPDDStock.ViewStockFragment
import com.breezefsmparaspanmasala.features.weather.presentation.WeatherFragment
import com.breezefsmparaspanmasala.mappackage.MapActivity
import com.breezefsmparaspanmasala.mappackage.MapActivityWithoutPath
import com.breezefsmparaspanmasala.mappackage.SendBrod
import com.breezefsmparaspanmasala.widgets.AppCustomEditText
...
import com.breezefsmparaspanmasala.app.NewFileUtils.browsePDFDocuments
import com.breezefsmparaspanmasala.features.marketAssist.MarketAssistTabFrag
import com.breezefsmparaspanmasala.features.marketAssist.ShopDtlsMarketAssistFrag
import com.breezefsmparaspanmasala.features.marketAssist.ShopListMarketAssistFrag
import com.breezefsmparaspanmasala.features.performanceAPP.OwnPerformanceFragment
import com.breezefsmparaspanmasala.features.performanceAPP.allPerformanceFrag
import com.breezefsmparaspanmasala.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xbreezefsmparaspanmasalalogsample/log").path);
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmparaspanmasalalogsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.breezefsmparaspanmasala/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmparaspanmasalalogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmparaspanmasalalogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmparaspanmasalalogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmparaspanmasalalogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
