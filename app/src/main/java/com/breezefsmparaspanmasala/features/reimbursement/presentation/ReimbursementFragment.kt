package com.breezefsmparaspanmasala.features.reimbursement.presentation
...
import com.breezefsmparaspanmasala.app.utils.AppUtils.Companion.convertFromRightToReverseFormatWithTime
import com.breezefsmparaspanmasala.app.utils.AppUtils.Companion.getFormattedDateForApi
import com.breezefsmparaspanmasala.app.utils.AppUtils.Companion.hideSoftKeyboard
import com.breezefsmparaspanmasala.app.utils.CustomTextWatcher
import com.breezefsmparaspanmasala.app.utils.PermissionUtils
import com.breezefsmparaspanmasala.app.utils.ProcessImageUtils_v1
...
import com.breezefsmparaspanmasala.features.reimbursement.api.ReimbursementConfigRepoProvider
import com.breezefsmparaspanmasala.features.reimbursement.api.applyapi.ApplyReimbursementRepoProvider
import com.breezefsmparaspanmasala.features.reimbursement.api.configfetchapi.ReimbursementConfigFetchRepoProvider
import com.breezefsmparaspanmasala.features.reimbursement.api.reimbursement_list_api.ReimbursementListRepoProvider
import com.breezefsmparaspanmasala.features.reimbursement.api.reimbursementshopapi.ReimbursementShopRepoProvider
import com.breezefsmparaspanmasala.features.reimbursement.model.*
import com.breezefsmparaspanmasala.features.reimbursement.model.reimbursement_shop.ReimbursementShopDataModel
import com.breezefsmparaspanmasala.features.reimbursement.model.reimbursement_shop.ReimbursementShopResponseModel
import com.breezefsmparaspanmasala.features.reimbursement.model.reimbursementlist.ReimbursementListDataModel
import com.breezefsmparaspanmasala.features.reimbursement.model.reimbursementlist.ReimbursementListDetailsModel
import com.breezefsmparaspanmasala.features.reimbursement.model.reimbursementlist.ReimbursementListResponseModel
...
class ReimbursementFragment : BaseFragment(), DateAdapter.onPetSelectedListener, View.OnClickListener, TabLayout.OnTabSelectedListener, RadioGroup.OnCheckedChangeListener {
    ...
    private fun initView(view: View) {
        ...
        //attachbreezefsmparaspanmasalaData()
...
//                            XLog.d("ReimbursementConfigApiResponse ERROR: " + error.localizedMessage)
    ...
    private fun attachbreezefsmparaspanmasalaData() {
